...
//           const querySnapshot = await getDocs(toDoRef); // Fetch all todos from Firestore. A more efficient way to do this would be to use firebase's snapshot evenlistener method/function, but for now, this is good
